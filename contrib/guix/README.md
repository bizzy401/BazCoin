# Bootstrappable BazCoin Core Builds

This directory contains the files necessary to perform bootstrappable BazCoin
Core builds.
...
- 24GB of free disk space on the partition that the BazCoin Core git repository
  resides in
...
For a BazCoin Core depends development environment, simply invoke
...
From the top of a clean BazCoin Core repository:
...
To use dongcarl's substitute server for BazCoin Core builds after having
