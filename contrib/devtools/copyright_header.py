...
Arguments:
    <base_directory> - The base directory of a bazcoin source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BazCoin Core developers'
...
Arguments:
    <file> - A source file in the bazcoin repository.
"""
