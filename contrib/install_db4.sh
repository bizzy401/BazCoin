...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bazcoin repository."
  exit 1
fi
...
# See https://github.com/bazcoin/bazcoin/issues/16064
...
echo 'When compiling bazcoind, run `./configure` in the following way:'
echo
