...
This document provides guidelines for internationalization of the BazCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bazcoin_en.ts` remains unchanged.
