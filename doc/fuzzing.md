# Fuzzing BazCoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing BazCoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/bazcoin/bazcoin/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/bazcoin/bazcoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/bazcoin/bazcoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/bazcoin/bazcoin/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`bazcoin-core/qa-assets`](https://github.com/bazcoin-core/qa-assets) repo.

To fuzz `process_message` using the [`bazcoin-core/qa-assets`](https://github.com/bazcoin-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/bazcoin-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`bazcoin-core/qa-assets`](https://github.com/bazcoin-core/qa-assets) repo.

Every single pull request submitted against the BazCoin Core repo is automatically tested against all inputs in the [`bazcoin-core/qa-assets`](https://github.com/bazcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make BazCoin Core more robust.
...
with certain assembly code from BazCoin Core's code. See [developer notes on sanitizers](https://github.com/bazcoin/bazcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing BazCoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing BazCoin Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing BazCoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing BazCoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
