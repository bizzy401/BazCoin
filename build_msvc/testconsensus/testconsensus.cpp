...
// bazcoin includes.
#include <..\src\script\bazcoinconsensus.h>
...
int main()
{
    std::cout << "bazcoinconsensus version: " << bazcoinconsensus_version() << std::endl;
    ...
    auto op0Result = bazcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bazcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
