...
class P2PPermissionsTests(BazCoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bazcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bazcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
