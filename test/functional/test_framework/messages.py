...
"""BazCoin test framework primitive and message structures
...
COIN = 100000000  # 1 baz in satoshis
MAX_MONEY = 21100000 * COIN
...
# Objects that map to bazcoind objects, which can be serialized/deserialized


class CAddress:
    __slots__ = ("net", "ip", "nServices", "port", "time")

    # see https://github.com/bazcoin/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in bazcoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
    ...
    def is_valid(self):
        ...
        for tout in self.vout:
            if tout.nValue < 0 or tout.nValue > 21100000 * COIN:
                return False
        return True
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in bazcoind indicates these should be deserialized as blocks
