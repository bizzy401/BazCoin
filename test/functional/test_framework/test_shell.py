...
class TestShell:
    """Wrapper Class for BazCoinTestFramework.

    The TestShell class extends the BazCoinTestFramework
    ...
    class __TestShell(BazCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BazCoinTestFramework child class.
            self.num_nodes = 1
