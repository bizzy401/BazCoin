...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BazCoinTestFramework
    pass


class ExampleTest(BazCoinTestFramework):
    # Each functional test is a subclass of the BazCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BazCoinTestFramework class so other tests can use it."""
