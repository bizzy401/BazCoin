...
"""Verify that starting bazcoin with -h works as expected."""

from test_framework.test_framework import BazCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BazCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bazcoin with -h for help text")
        ...
        self.log.info("Start bazcoin with -version for version information")
        ...
        self.log.info("Start bazcoind with -fakearg to make sure it does not start")
