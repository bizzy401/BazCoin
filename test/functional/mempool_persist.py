...
By default, bazcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BazCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bazcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
