...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/BazCoin
else
  DOCKER_EXEC echo \> \$HOME/.bazcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bazcoin/bazcoin/pull/18288#discussion_r433189350 for
  # details.
