...
{
    BOOST_CHECK(TestSplitHost("www.bazcoincore.org", "www.bazcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bazcoincore.org]", "www.bazcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bazcoincore.org:80", "www.bazcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bazcoincore.org]:80", "www.bazcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:35576", "127.0.0.1", 35576));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:35576", "127.0.0.1", 35576));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:35576", "::ffff:127.0.0.1", 35576));
    BOOST_CHECK(TestSplitHost("[::]:35576", "::", 35576));
    BOOST_CHECK(TestSplitHost("::35576", "::35576", -1));
    BOOST_CHECK(TestSplitHost(":35576", "", 35576));
    BOOST_CHECK(TestSplitHost("[]:35576", "", 35576));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:35576", "127.0.0.1:35576"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:35576", "[::]:35576"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
