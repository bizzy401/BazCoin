...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1BAZ 10000

// amounts 50 .. 21000000
#define NUM_MULTIPLES_50BAZ 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(21100000 * COIN, 0x1406f40));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1BAZ; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50BAZ; i++)
