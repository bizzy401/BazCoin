...
#ifndef BAZCOIN_TEST_SCRIPTNUM10_H
#define BAZCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BazCoin Core 0.10.0, for cross-comparison.
 */
public:
