...
#ifndef BAZCOIN_WALLET_WALLETUTIL_H
#define BAZCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bazcoin from opening the wallet, thinking it was newly created, and
...
#endif // BAZCOIN_WALLET_WALLETUTIL_H
