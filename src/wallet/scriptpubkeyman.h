...
#ifndef BAZCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BAZCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BazCoin Core wallet was originally a collection of unrelated private
...
#endif // BAZCOIN_WALLET_SCRIPTPUBKEYMAN_H
