...
#ifndef BAZCOIN_SCRIPT_INTERPRETER_H
#define BAZCOIN_SCRIPT_INTERPRETER_H
...
struct PrecomputedTransactionData
{
    ...
    // These are single-SHA256, see https://github.com/bazcoin/bips/blob/master/bip-0341.mediawiki#cite_note-15.
...
#endif // BAZCOIN_SCRIPT_INTERPRETER_H
