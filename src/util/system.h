 ...
 */
#ifndef BAZCOIN_UTIL_SYSTEM_H
#define BAZCOIN_UTIL_SYSTEM_H
...
extern const char * const BAZCOIN_CONF_FILENAME;
extern const char * const BAZCOIN_SETTINGS_FILENAME;
