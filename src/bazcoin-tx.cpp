...
static void SetupBazCoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bazcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bazcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bazcoin transaction\n" +
            "or:     bazcoin-tx [options] -create [commands]   Create hex-encoded bazcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bazcoin transaction
