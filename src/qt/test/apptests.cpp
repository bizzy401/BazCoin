...
//! Entry point for BazCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BazCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BazCoinGUI tests.
void AppTests::guiTests(BazCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BazCoinGUI::consoleShown, this, &AppTests::consoleTests);
