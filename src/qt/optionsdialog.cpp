    ...
    mapper(nullptr)
{
    ...
    ui->bazcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bazcoinAtStartup);
    ...
    ui->bazcoinAtStartup->setToolTip(ui->bazcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bazcoinAtStartup->setText(ui->bazcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBazCoinConfButton->setToolTip(ui->openBazCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BazCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bazcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBazCoinConfButton_clicked()
{
