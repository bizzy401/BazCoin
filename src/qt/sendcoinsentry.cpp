    ...
    platformStyle(_platformStyle)
{
    ...
    // normal bazcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying bazcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BazCoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
