...
#ifndef BAZCOIN_QT_GUIUTIL_H
#define BAZCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the BazCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bazcoin:" URI into recipient object, return true on successful parsing
