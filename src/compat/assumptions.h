...
#ifndef BAZCOIN_COMPAT_ASSUMPTIONS_H
#define BAZCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BazCoin cannot be compiled without assertions."
#endif
...
#endif // BAZCOIN_COMPAT_ASSUMPTIONS_H
