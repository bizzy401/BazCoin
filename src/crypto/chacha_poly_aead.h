...
#ifndef BAZCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BAZCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bazcoin.
 *
 ...
 *
 * The chacha20-poly1305@bazcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bazcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bazcoin are relatively fast in
...
#endif // BAZCOIN_CRYPTO_CHACHA_POLY_AEAD_H
