...
#ifndef BAZCOIN_INTERFACES_NODE_H
#define BAZCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a bazcoin node (bazcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BAZCOIN_INTERFACES_NODE_H
